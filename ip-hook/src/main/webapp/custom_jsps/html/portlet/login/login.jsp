...
<c:choose>
	...
	<c:otherwise>
		...
		<aui:form action="<%= loginURL %>" autocomplete='<%= PropsValues.COMPANY_SECURITY_LOGIN_FORM_AUTOCOMPLETE ? "on" : "off" %>' cssClass="sign-in-form" method="post" name="fm">
			...
			<liferay-ui:error key="no-such-user-exception" message="No User Found, Authentication failed. Please try again." />
			<liferay-ui:error key="inactive-user-exception" message="User has been deactivated. Please contact admin." />
			<aui:fieldset>
