...
import za.co.idea.ip.hook.service.IpLoginService;
...
/**
 * Provides the base implementation for the ip login remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link za.co.idea.ip.hook.service.impl.IpLoginServiceImpl}.
 * </p>
 *
 * @author VMPattamatta
 ...
 * @generated
 */
public abstract class IpLoginServiceBaseImpl extends BaseServiceImpl
    implements IpLoginService, IdentifiableBean {
    ...
    private IpLoginServiceClpInvoker _clpInvoker = new IpLoginServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link za.co.idea.ip.hook.service.IpLoginServiceUtil} to access the ip login remote service.
     */
