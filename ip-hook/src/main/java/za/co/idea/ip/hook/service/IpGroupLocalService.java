...
/**
 * Provides the local service interface for IpGroup. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author VMPattamatta
 * @see IpGroupLocalServiceUtil
...
public interface IpGroupLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link IpGroupLocalServiceUtil} to access the ip group local service. Add custom service methods to {@link za.co.idea.ip.hook.service.impl.IpGroupLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
