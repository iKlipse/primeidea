...
import za.co.idea.ip.hook.service.IpSecqListService;
...
/**
 * Provides the base implementation for the ip secq list remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link za.co.idea.ip.hook.service.impl.IpSecqListServiceImpl}.
 * </p>
 *
 * @author VMPattamatta
 ...
 * @generated
 */
public abstract class IpSecqListServiceBaseImpl extends BaseServiceImpl
    implements IpSecqListService, IdentifiableBean {
    ...
    private IpSecqListServiceClpInvoker _clpInvoker = new IpSecqListServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link za.co.idea.ip.hook.service.IpSecqListServiceUtil} to access the ip secq list remote service.
     */
