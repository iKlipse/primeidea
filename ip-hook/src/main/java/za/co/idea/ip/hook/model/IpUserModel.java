...
/**
 * The base model interface for the IpUser service. Represents a row in the
 * &quot;ip_user&quot; database table, with each column mapped to a property of
 * this class.
 *
 * <p>
 * This interface and its corresponding implementation
 * {@link za.co.idea.ip.hook.model.impl.IpUserModelImpl} exist only as a
 ...
 * {@link za.co.idea.ip.hook.model.impl.IpUserImpl}.
 * </p>
 *
 * @author VMPattamatta
 * @see IpUser
...
public interface IpUserModel extends BaseModel<IpUser> {
	 ...
	 * NOTE FOR DEVELOPERS:
	 * 
	 * Never modify or reference this interface directly. All methods that
	 * expect a ip user model instance should use the {@link IpUser} interface
	 * instead.
	 */
	 ...
	 *
	 * @param primaryKey
	 *            the primary key of this ip user
	 */
	 ...
	 *
	 * @param userFName
	 *            the user f name of this ip user
	 */
	 ...
	 *
	 * @param userLName
	 *            the user l name of this ip user
	 */
	 ...
	 *
	 * @param userMName
	 *            the user m name of this ip user
	 */
	 ...
	 *
	 * @param userIdNum
	 *            the user ID num of this ip user
	 */
	 ...
	 *            the user screen name of this ip user
	 */
	 ...
	 *
	 * @param userEmail
	 *            the user email of this ip user
	 */
	 ...
	 *
	 * @param userContact
	 *            the user contact of this ip user
	 */
	 ...
	 *
	 * @param userSkills
	 *            the user skills of this ip user
	 */
	 ...
	 *
	 * @param userFbHandle
	 *            the user fb handle of this ip user
	 */
	 ...
	 *
	 * @param userTwHandle
	 *            the user tw handle of this ip user
	 */
	 ...
	 *
	 * @param userStatus
	 *            the user status of this ip user
	 */
	 ...
	 *            the user employee ID of this ip user
	 */
	 ...
	 *
	 * @param priGrpId
	 *            the pri grp ID of this ip user
	 */
