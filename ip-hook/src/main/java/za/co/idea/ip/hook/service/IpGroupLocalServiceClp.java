...
public class IpGroupLocalServiceClp implements IpGroupLocalService {
    ...
    public IpGroupLocalServiceClp(InvokableLocalService invokableLocalService) {
    ...
    public za.co.idea.ip.hook.model.IpGroup addIpGroup(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(ipGroup) });
        } catch (Throwable t) {
        ...
        return (za.co.idea.ip.hook.model.IpGroup) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<za.co.idea.ip.hook.model.IpGroup> getIpGroups(
        ...
        return (java.util.List<za.co.idea.ip.hook.model.IpGroup>) ClpSerializer.translateOutput(returnObj);
    }
