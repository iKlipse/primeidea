...
import za.co.idea.ip.hook.service.IpGroupService;
...
/**
 * Provides the base implementation for the ip group remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link za.co.idea.ip.hook.service.impl.IpGroupServiceImpl}.
 * </p>
 *
 * @author VMPattamatta
 ...
 * @generated
 */
public abstract class IpGroupServiceBaseImpl extends BaseServiceImpl
    implements IpGroupService, IdentifiableBean {
    ...
    private IpGroupServiceClpInvoker _clpInvoker = new IpGroupServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link za.co.idea.ip.hook.service.IpGroupServiceUtil} to access the ip group remote service.
     */
