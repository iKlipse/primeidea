...
/**
 * Provides the local service interface for IpUser. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author VMPattamatta
 * @see IpUserLocalServiceUtil
...
public interface IpUserLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link IpUserLocalServiceUtil} to access the ip user local service. Add custom service methods to {@link za.co.idea.ip.hook.service.impl.IpUserLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
