...
import za.co.idea.ip.hook.service.IpLoginLocalService;
...
/**
 * Provides the base implementation for the ip login local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link za.co.idea.ip.hook.service.impl.IpLoginLocalServiceImpl}.
 * </p>
 *
 * @author VMPattamatta
 * @see za.co.idea.ip.hook.service.impl.IpLoginLocalServiceImpl
 * @see za.co.idea.ip.hook.service.IpLoginLocalServiceUtil
 * @generated
 */
public abstract class IpLoginLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements IpLoginLocalService, IdentifiableBean {
    ...
    private IpLoginLocalServiceClpInvoker _clpInvoker = new IpLoginLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link za.co.idea.ip.hook.service.IpLoginLocalServiceUtil} to access the ip login local service.
     */
    ...
    @Override
    public IpLogin addIpLogin(IpLogin ipLogin) throws SystemException {
        ipLogin.setNew(true);

        return ipLoginPersistence.update(ipLogin);
    }
     ...
     */
    @Override
    public IpLogin createIpLogin(long loginId) {
        return ipLoginPersistence.create(loginId);
    }
    ...
    @Override
    public IpLogin deleteIpLogin(long loginId)
        throws PortalException, SystemException {
        return ipLoginPersistence.remove(loginId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public IpLogin deleteIpLogin(IpLogin ipLogin) throws SystemException {
        return ipLoginPersistence.remove(ipLogin);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(IpLogin.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return ipLoginPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return ipLoginPersistence.findWithDynamicQuery(dynamicQuery, start, end);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
        ...
        return ipLoginPersistence.findWithDynamicQuery(dynamicQuery, start,
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return ipLoginPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery,
        ...
        return ipLoginPersistence.countWithDynamicQuery(dynamicQuery, projection);
    }

    @Override
    public IpLogin fetchIpLogin(long loginId) throws SystemException {
        return ipLoginPersistence.fetchByPrimaryKey(loginId);
    }
     ...
     */
    @Override
    public IpLogin getIpLogin(long loginId)
        throws PortalException, SystemException {
        return ipLoginPersistence.findByPrimaryKey(loginId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return ipLoginPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<IpLogin> getIpLogins(int start, int end)
        throws SystemException {
        return ipLoginPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getIpLoginsCount() throws SystemException {
        return ipLoginPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public IpLogin updateIpLogin(IpLogin ipLogin) throws SystemException {
        return ipLoginPersistence.update(ipLogin);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("za.co.idea.ip.hook.model.IpLogin",
            ipLoginLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = ipLoginPersistence.getDataSource();
