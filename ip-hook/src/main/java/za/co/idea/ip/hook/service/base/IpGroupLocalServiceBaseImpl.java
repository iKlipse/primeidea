...
import za.co.idea.ip.hook.service.IpGroupLocalService;
...
/**
 * Provides the base implementation for the ip group local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link za.co.idea.ip.hook.service.impl.IpGroupLocalServiceImpl}.
 * </p>
 *
 * @author VMPattamatta
 * @see za.co.idea.ip.hook.service.impl.IpGroupLocalServiceImpl
 * @see za.co.idea.ip.hook.service.IpGroupLocalServiceUtil
 * @generated
 */
public abstract class IpGroupLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements IpGroupLocalService, IdentifiableBean {
    ...
    private IpGroupLocalServiceClpInvoker _clpInvoker = new IpGroupLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link za.co.idea.ip.hook.service.IpGroupLocalServiceUtil} to access the ip group local service.
     */
    ...
    @Override
    public IpGroup addIpGroup(IpGroup ipGroup) throws SystemException {
        ipGroup.setNew(true);

        return ipGroupPersistence.update(ipGroup);
    }
     ...
     */
    @Override
    public IpGroup createIpGroup(long groupId) {
        return ipGroupPersistence.create(groupId);
    }
    ...
    @Override
    public IpGroup deleteIpGroup(long groupId)
        throws PortalException, SystemException {
        return ipGroupPersistence.remove(groupId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public IpGroup deleteIpGroup(IpGroup ipGroup) throws SystemException {
        return ipGroupPersistence.remove(ipGroup);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(IpGroup.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return ipGroupPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return ipGroupPersistence.findWithDynamicQuery(dynamicQuery, start, end);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
        ...
        return ipGroupPersistence.findWithDynamicQuery(dynamicQuery, start,
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return ipGroupPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery,
        ...
        return ipGroupPersistence.countWithDynamicQuery(dynamicQuery, projection);
    }

    @Override
    public IpGroup fetchIpGroup(long groupId) throws SystemException {
        return ipGroupPersistence.fetchByPrimaryKey(groupId);
    }
     ...
     */
    @Override
    public IpGroup getIpGroup(long groupId)
        throws PortalException, SystemException {
        return ipGroupPersistence.findByPrimaryKey(groupId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return ipGroupPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<IpGroup> getIpGroups(int start, int end)
        throws SystemException {
        return ipGroupPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getIpGroupsCount() throws SystemException {
        return ipGroupPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public IpGroup updateIpGroup(IpGroup ipGroup) throws SystemException {
        return ipGroupPersistence.update(ipGroup);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("za.co.idea.ip.hook.model.IpGroup",
            ipGroupLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = ipGroupPersistence.getDataSource();
