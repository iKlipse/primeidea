...
public class IpChallengeDAO extends BaseHibernateDAO {
	...
	public List findCreatedByUserId(Long id) {
		...
		Transaction transaction = session.beginTransaction();
		try {
			Query query = session.getNamedQuery("getChallengeCreatedByUser");
			query.setLong("id", id);
			List ret = query.list();
			for (Object object : ret) {
				IpChallenge chal = (IpChallenge) object;
	...
	public List findByStatusIdUserId(Integer sid, Long id) {
		...
		Transaction transaction = session.beginTransaction();
		try {
			Query query = session.getNamedQuery("getChallengeByStatusUser");
	...
	public List findReviewChalsByUserId(Long id) {
		...
		Transaction transaction = session.beginTransaction();
		try {
			Query query = session.getNamedQuery("getReviewChallengesByUser");
			query.setLong("id", id);
			List ret = query.list();
			for (Object object : ret) {
				IpChallenge chal = (IpChallenge) object;
